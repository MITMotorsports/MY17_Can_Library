...
typedef enum {
  ...
  CAN_BMS_ERROR_CONTROL_FLOW =____BMS_ERRORS__ERROR_TYPE__CONTROL_FLOW,
  CAN_BMS_ERROR_OTHER =____BMS_ERRORS__ERROR_TYPE__OTHER,
} Can_Bms_ErrorID_T;
...
typedef enum {
  ...
  CAN_MC_REG_CURRENT_AFTER_DISPLAY = ____MC_RESPONSE__REG_ID__CURRENT_ACTUAL_FILTERED,
  ...
  CAN_MC_REG_SPEED_CMD_BEFORE_RAMP = ____MC_RESPONSE__REG_ID__SPEED_CMD_BEFORE_RAMP,
  CAN_MC_REG_SPEED_CMD_AFTER_RAMP = ____MC_RESPONSE__REG_ID__SPEED_CMD_AFTER_RAMP,
  ...
  CAN_MC_REG_OUTPUT_VOLTAGE = ____MC_RESPONSE__REG_ID__OUTPUT_VOLTAGE,
  CAN_MC_REG_OUTPUT_VOLTAGE_LIMIT = ____MC_RESPONSE__REG_ID__OUTPUT_VOLTAGE_LIMIT,
...
typedef enum {
  ...
  CAN_DASH_REQUEST_TRACTION_CONTROL_ENABLE = ____DASH_REQUEST__REQUEST_TYPE__TRACTION_CONTROL_ENABLE,
  CAN_DASH_REQUEST_TRACTION_CONTROL_DISABLE = ____DASH_REQUEST__REQUEST_TYPE__TRACTION_CONTROL_DISABLE,
  CAN_DASH_REQUEST_ACTIVE_AERO_ENABLE = ____DASH_REQUEST__REQUEST_TYPE__ACTIVE_AERO_ENABLE,
  CAN_DASH_REQUEST_ACTIVE_AERO_DISABLE = ____DASH_REQUEST__REQUEST_TYPE__ACTIVE_AERO_DISABLE,
  CAN_DASH_REQUEST_FAN_ENABLE = ____DASH_REQUEST__REQUEST_TYPE__FAN_ENABLE,
  CAN_DASH_REQUEST_FAN_DISABLE = ____DASH_REQUEST__REQUEST_TYPE__FAN_DISABLE,
